...
declare namespace screenshot {
    var canvas: (target: Element | string, options?: RenderOptions) => Promise<HTMLCanvasElement>;
    var blob: (target: Element | string, options?: ScreenshotOptions) => Promise<Blob>;
    var url: (target: Element | string, options?: ScreenshotOptions) => Promise<string>;
}
export { screenshot };
declare global {
